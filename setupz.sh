...
dependencies
clear
wget https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/domaincf.sh
chmod 777 domaincf.sh && ./domaincf.sh
function tambahtema(){
...
#wget -q -O /usr/bin/xrayfix "https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/xrayfix.sh" && chmod +x /usr/bin/xrayfix
#wget -q -O /usr/bin/fixdb "https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/fixdb.sh" && chmod +x /usr/bin/fixdb
wget -q -O /usr/bin/gantidomain "https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/gantidomain.sh" && chmod +x /usr/bin/gantidomain.sh
...
#wget -q -O /usr/bin/updatesshws "https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/updatesshws.sh" && chmod +x /usr/bin/updatesshws
#wget -q -O /usr/bin/sshwsfix "https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/sshwsfix.sh" && chmod +x /usr/bin/sshwsfix
#wget -q -O /usr/bin/xraydbfix "https://raw.githubusercontent.com/YaddyKakkoii/sclifetime/main/xraydbfix.sh" && chmod +x /usr/bin/xraydbfix
...
rm -rf /root/semuamenu > /dev/null 2>&1
mkdir -p /root/semuamenu
cd /root/semuamenu
